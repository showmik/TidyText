...
{
    public class PunctuationProcessorOptions : ProcessorOptions
    {
        public bool FixPunctuationSpacing { get; set; } = false;
        public bool TreatColonAsSentencePunct { get; set; } = false;
        public bool SpaceAfterColon { get; set; } = false;
    }

    public class PunctuationProcessor : ITextProcessor
    {
        ...
        private static string FixPunctuationSpacing(string input, bool treatColonAsSentencePunct = false, bool spaceAfterColon = false)
        {
